...
from .models import ParsedResume, MatchResult
...
def parse_resume_with_llm(resume_text: str) -> ParsedResume:
    ...
    The JSON output *must* strictly adhere to the provided schema. If a value is not found, use null. Do not add any extra text, explanations, or markdown formatting around the JSON.
